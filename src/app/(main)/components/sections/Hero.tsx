...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative flex flex-col lg:flex-row justify-center lg:justify-start items-center lg:items-stretch min-h-screen px-6 md:px-12 lg:px-24 xl:px-52 pt-28 lg:pt-0 overflow-hidden"
    >
      <div className="flex flex-col space-y-6 h-full items-start justify-center w-full lg:max-w-[750px] z-10 mt-10 lg:mt-52">
      ...
      <div className="relative lg:absolute z-0 right-0 bottom-0 mt-12 lg:mt-0 flex justify-end w-full max-w-[300px] md:max-w-[450px] lg:max-w-[618px]">
        <Image
